        ...
        this.showPopup(
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
            <tbody>
              ...
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);font-weight:600;vertical-align:top;">Itinerary</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Seoul → Wanju → Naju → Jeonju → Sejong → Seoul</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);font-weight:600;vertical-align:top;">Participating Countries</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Republic of Zambia; Republic of Madagascar</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);font-weight:600;vertical-align:top;">Total Participants</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">26 persons (Government Officials, WBG Staff, WFP Staff)</td></tr>
              <tr><td style="padding:7px 10px;font-weight:600;vertical-align:top;">Program Objectives</td><td style="padding:7px 10px;vertical-align:top;">To enhance participants' understanding of Korea's school meal policy framework, financing mechanisms, operational systems, and food safety governance; to explore institutional and technical applicability in participating African countries; and to strengthen capacity for improved nutrition, local agricultural linkages, and sustainable school feeding systems.</td></tr>
            </tbody>
          </table>
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
            ...
            <tbody>
              ...
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">09:30–10:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Orientation</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Introduction to host institutions, program objectives, and institutional focal points for each site visit.</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">10:00–12:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Expert Lecture — Overview of Korea's School Meal System</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Delivered by Dr. Yoon Sangchul (Korea Catholic University). 75-minute presentation on historical development, policy framework, financing structure, and food safety governance, followed by a 45-minute open discussion.</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">12:00–13:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Lunch</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;"></td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">14:00–15:30</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Seoul Metropolitan Office of Education</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Roundtable chaired by the Deputy Superintendent of Education, examining Korea's development trajectory from low-income country to universal free provision as a case of institutional aspiration.</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">16:00–17:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Eunpyeong-gu Children's & Social Welfare Foodservice Management Center</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Focus on technical guidance and administrative training for nutrition management, hygiene, and food safety practices.</td></tr>
              <tr><td style="padding:7px 10px;vertical-align:top;">18:00–19:30</td><td style="padding:7px 10px;vertical-align:top;font-weight:600;">Welcome Dinner</td><td style="padding:7px 10px;vertical-align:top;"></td></tr>
            </tbody>
          </table>
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
            ...
            <tbody>
              ...
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">10:00–11:30</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Hanil Highschool</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Structured visit to observe school meal delivery and preparation. Roundtable with school principal and technical discussion with the school nutritionist.</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">12:00–13:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Lunch</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;"></td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">13:00–15:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Wanju Food Integration Centre & Local Food Team</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Guided tour of intake, inspection, sorting, packaging, and dispatch facilities, followed by a structured dialogue on operational architecture and farmer participation conditions.</td></tr>
              <tr><td style="padding:7px 10px;vertical-align:top;">15:00–16:40</td><td style="padding:7px 10px;vertical-align:top;font-weight:600;">Local Farm Walking Tour & Agri-Food Processing Facility</td><td style="padding:7px 10px;vertical-align:top;">Walking tour tracing the production-to-centre supply chain, followed by a visit to a surplus agri-food processing facility illustrating food loss reduction and value-addition mechanisms.</td></tr>
            </tbody>
          </table>
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
            ...
            <tbody>
              ...
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">09:30–11:30</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">aT — Integrated Local Food Direct Sales Centre & School Meal Support Centre</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Field visit observing intake and display of locally sourced agricultural produce, with briefing on operational linkages among rural revitalization, local food policy, and public school feeding procurement.</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">12:00–13:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Lunch</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;"></td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">13:00–15:30</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Korea Agro-Fisheries & Food Trade Corporation (aT)</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Overview of aT's four functional divisions, demonstration of the neaT and seaT digital procurement systems, and roundtable with the Director of the Public Food Division.</td></tr>
              <tr><td style="padding:7px 10px;vertical-align:top;">15:30–17:30</td><td style="padding:7px 10px;vertical-align:top;font-weight:600;">Korea Rural Economic Institute (KREI)</td><td style="padding:7px 10px;vertical-align:top;">Expert lecture by Dr. Eunmi Jeong on direct agricultural trade and local food distribution structures, followed by a one-hour research roundtable.</td></tr>
            </tbody>
          </table>
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
            ...
            <tbody>
              ...
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">12:45–13:45</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Lunch</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;"></td></tr>
              <tr><td style="padding:7px 10px;vertical-align:top;">13:45–15:00</td><td style="padding:7px 10px;vertical-align:top;font-weight:600;">Ministry of Education — Student Health Policy Division</td><td style="padding:7px 10px;vertical-align:top;">Policy dialogue on the national school meals policy framework and the multi-tier budget structure (Ministry of Education → Provincial Education Office → Local Government → School), with informal policy exchange.</td></tr>
            </tbody>
          </table>
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:0;">
            ...
            <tbody>
              ...
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">11:00–11:30</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Country Presentation (Zambia)</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Presentations by Zambian government officials from Ministries of Education and Agriculture, outlining proposed strategies for applying study tour findings domestically.</td></tr>
              <tr><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">11:30–12:00</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;font-weight:600;">Country Presentation (Madagascar)</td><td style="padding:7px 10px;border-bottom:1px solid var(--border);vertical-align:top;">Presentations by Malagasy government officials from Ministries of Education and Agriculture, outlining proposed strategies for applying study tour findings domestically.</td></tr>
              <tr><td style="padding:7px 10px;vertical-align:top;">12:00–13:00</td><td style="padding:7px 10px;vertical-align:top;font-weight:600;">Networking Lunch</td><td style="padding:7px 10px;vertical-align:top;"></td></tr>
            </tbody>
          </table>`
        );
        break;
